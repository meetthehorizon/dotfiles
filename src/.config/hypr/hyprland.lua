...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl -e4 --device='amdgpu_bl*' -n2 set 5%+"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("brightnessctl -e4 --device='amdgpu_bl*' -n2 set 5%-"), { locked = true, repeating = true })
